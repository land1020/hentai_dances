...
export const CARD_DEFINITIONS: Record<CardType, Omit<Card, 'id'>> = {
    first_discoverer: {
        ...
        targetType: 'NONE',
        sortOrder: 10,
        icon: '/cards/first_discoverer.png',
    },
    culprit: {
        type: 'culprit',
        name: '変態',
