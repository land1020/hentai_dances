...
export const AbnormalWords: string[] = [
    ...
    '手コキのプロ', '名器の', '浮気中⇒', 'ホモ⇒', 'パイパンの',
    '即ハメの', '騎乗位大好き', '駅弁が得意な', '尻を振れ', 'お尻好きの',
    'ほらイクぞ', '跪け', '豚野郎', 'ザコちんぽの', 'アヘ顔の',
    '絶頂中の', '陥没乳首の', '援助交際の', '仮性包茎の', 'オフパコ希望の',
    '飛べねぇ豚はただの', 'ゴムは絶対付けない', 'バイアグラ常中', 'Tバックを履いた', 'ブラジャーを被った',
    '69大好きな', 'チンポ・ギス・ハン', 'プリケツ・オイゲン', 'マンコ・テカリーナ'
];
...
export const DangerWords: string[] = [
    ...
    '真正包茎の', 'おぼ”っｲｸﾞ❤❤❤', '種付けプレスの', '鼻フックしてほしい', '黄金プレイ願望の',
    'パイズリ最高', 'ソープへ行こう', 'ぶっかけ大好きな', '高速ピストンの', '公衆便所の',
    'ローター挿入中の', 'メスイキ経験者', '尿道責めの', '床オナでしかイケない'
];
